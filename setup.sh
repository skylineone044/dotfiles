...
echo - getting pylint...
sudo apt install pylint pylint3 || sudo apt install python-pylint python3-pylint || sudo apt install python2-pylint python-pylint || sudo pacman -S pylint pylint3  || sudo pacman -S python-pylint python3-pylint || sudo pacman -S python2-pylint python-pylint
